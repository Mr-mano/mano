...
$design_id = getById($id, 'titre_design');
            ...
            if(isset($_POST['id']) && isset($_FILES['logo_ps']['name'])){
                ...
                updateEntity("titre_design", $id, [ 'logo_ps' => $logo_ps['name']]);
...
<?php require_once __DIR__ . "/layout/erreur404.php"; ?>
    ...
    <?php } else { ?>  
        ...
        <section class="page-section">
                <form method="POST" action="update_titre_design_logo_ps.php" enctype="multipart/form-data">
                    <div class="container bg-light p-5 my-5">
                            <div class="form-group">
                                <div class="text-align-center">
                                    <label for="exampleFormControlFile1"></label>
                                    <input type="file" name="logo_ps" class="form-control-file"  value="<?= $design_id["logo_ps"]; ?>"></input>
                                </div>
