...
$phare_id = getById($id, 'phare');
            ...
            if(isset($_POST['id']) && isset($_FILES['image1_ph']['name'])){
                ...
                updateEntity("phare", $id, [ 'image1_ph' => $image1_ph['name']]);
                {
...
<?php require_once __DIR__ . "/layout/erreur404.php"; ?>
    ...
    <?php } else { ?>  
        ...
        <section class="page-section">
                <form method="POST" action="update_phare_img1.php" enctype="multipart/form-data">
                    <div class="container bg-light p-5 my-5">
                            <div class="form-group">
                                <div class="text-align-center">
                                    <label for="exampleFormControlFile1"></label>
                                    <input type="file" name="image1_ph" class="form-control-file"  value="<?= $phare_id["image1_ph"]; ?>"></input>
                                </div>
